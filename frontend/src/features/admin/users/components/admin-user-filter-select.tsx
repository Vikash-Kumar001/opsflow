...
type AdminUserFilterOption<TValue extends string> = {
  value: TValue;
  label: string;
};

type AdminUserFilterSelectProps<TValue extends string> = {
  label: string;
  value: TValue | "";
  options: Array<AdminUserFilterOption<TValue>>;
  onChange: (value: TValue | undefined) => void;
  className?: string;
};

export function AdminUserFilterSelect<TValue extends string>({
  label,
  value,
  options,
  onChange,
  className,
}: AdminUserFilterSelectProps<TValue>) {
  return (
