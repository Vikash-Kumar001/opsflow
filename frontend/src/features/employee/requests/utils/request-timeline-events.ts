import type { RequestSummary, RequestTimelineEvent } from "@/features/shared/requests";

export function buildEmployeeRequestTimeline(
  ...
  if (request.submittedAt) {
    events.push({
      ...
      description: "The request moved to pending review.",
    });
  }
  ...
  if (request.status === "IN_REVIEW") {
    events.push({
      ...
      description: "A reviewer is working on this request.",
    });
  }
