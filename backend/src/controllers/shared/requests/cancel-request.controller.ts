...
import { cancelOwnedRequest } from "../../../services/shared/requests/cancel-request.service.js";
import type { RequestIdParams } from "../../../validators/shared/requests/request.schemas.js";
import { sendSuccess } from "../../../utils/api-response.js";

export const cancelRequestController: RequestHandler = async (
  req,
  res,
  next,
) => {
  try {
    ...
    const request = await cancelOwnedRequest(prisma, req.user, params.id);
